...
st.sidebar.markdown(
    """
    <h2 style="color:silver; text-align:center;">The Real Team Tu at UCSD:</h2>
    <style> 
    ...
    <p class="solid">
        <ul >
            ...
            <strong class="text">Arvin:</strong> CS major from 
            Marshall College</li>
            <li class="descriptions">
            <strong class="text">Chuong:</strong> CS major from 
            Marshall College</li>
            <li class="descriptions">
            <strong class="text">Max:</strong> CS major from Sixth 
            College</li>
            <li class="descriptions">
            <strong class="text">Rebecca:</strong> Cog Sci major 
            from Sixth College</li>
            <li class="descriptions">
            <strong class="text">Rohan:</strong> ECE major from 
            Marshall College</li>
            <li class="descriptions">
            <strong class="text">Siya:</strong> CS major from 
            Seventh College</li>
            <li class="descriptions">
            <strong class="text">Vincent:</strong> CS major from 
            Sixth College</li>
        </ul>
    ...
    <br><br><br>
    <h2 style="color:silver; text-align:center;">Useful Resources on Google:</h2>
    <p class="solid">
        <ul>
            <li class="silverText"><a class="helpfulLinks;" 
...
selected = option_menu(
    ...
    styles={
        "container": {"background-color": "#557A95", "border-radius" : "0px;", "border": "2px solid lightgray;"},
        "icon": {"color": "#B1A296", "font-size": "25px"}, 
        "nav-link": {"font-size": "16px", "text-align": "left",  "--hover-color": "#8eaabe"},
        "nav-link-selected": {"background-color": "#4a6b82"},
    }
)
